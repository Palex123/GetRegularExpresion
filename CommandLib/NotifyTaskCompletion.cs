...
namespace CommandLib
{
    public sealed class NotifyTaskCompletion<TResult> : INotifyPropertyChanged
    {
        ...
        private async Task WatchTaskAsync(Task<TResult> task)
        {
            ...
            {
                propertyChanged(this, new PropertyChangedEventArgs("IsSuccesfullyCompleted"));
        ...
        public bool IsSuccesfullyCompleted
        {
        ...
        {
            get { return (Exception == null) ? null : InnerException.Message; }
        }
